...
| `remnote_search`          | Search knowledge base with full-text search and note metadata such as tags |
| `remnote_search_by_tag`   | Search by tag with ancestor-context resolution |
| `remnote_read_note`       | Read note by ID with metadata, tags, and markdown or structured content |

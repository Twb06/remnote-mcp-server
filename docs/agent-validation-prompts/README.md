...
Property and managed-media checks use the persistent fixtures `Automation Bridge Test Tag` and
`Automation Bridge Test Media`, whose setup is documented in the integration-testing guide.

...
It resolves the persistent fixtures `Automation Bridge Test Tag` and `Automation Bridge Test Media` by exact title;
their setup contract is documented in the integration guide.
